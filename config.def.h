...
static const char *fonts[]          = { "IosevkaTermSlab Nerd Font Mono:size=12:style=Thin" };
static const char dmenufont[]       = "IosevkaTermSlab Nerd Font Mono:size=12:style=Thin";
...
static const char *dmenucmd[] = { "dmenu_run", "-l", "5", "-m", dmenumon, "-fn", dmenufont, "-nb", normbgcolor, "-nf", normfgcolor, "-sb", selbgcolor, "-sf", selfgcolor, NULL };
